"""Utils function to work with Google Drive"""
...
def download_file_to_local(
    file_id: str, file_name: str, local_folder: Path, delete_in_drive: bool = True, verbose: int = 1
) -> None:
...
def get_files_in_folder(folder_name: str, return_names: bool = False) -> List[Union[GoogleDriveFile, str]]:
    """
    ...
    Returns:
        List[Union[GoogleDriveFile, str]]: List of files (or filenames)
    """
...
def create_drive_folder(folder_name: str) -> None:
    ...
    for i, folder in enumerate(folders):
        ...
        query = f"title='{folder}' and '{parent_id}' in parents and mimeType='application/vnd.google-apps.folder' and trashed=false"
...
if __name__ == "__main__":
    ...
    cfg = OmegaConf.create(
        dict(
            ...
            data=dict(
                ...
                time_periods=None,
                time_periods_pos=dict(pre=("2020-02-24", "2021-02-23"), post=("2021-02-24", "2022-02-23")),
                time_period_neg=dict(pre=("2020-02-24", "2021-02-23"), post=("2022-02-24", "2023-02-23")),
            ),
            seed=123,
            run_name="240223",
        )
    ...
    # create_yaml_file_in_drive_from_config_dict(cfg, folder_name)
